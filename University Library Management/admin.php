<html>
    ...
    <body>
            ...
            <div class="user" onclick="getprof()">
                <a href="#">
                    ...
                    <div id="dropList" class="dropList">
                        ...
                        <form method="post">
                        <button  name="logOut" class="logout">log out</button></form>
                    </div>
        ...
        <ul class="adminMenu">
         <li><input type="button" onclick="getAddBook();" value="Add Book"></li>
         
         <li><input type="button" onclick="getEditBook();" value="Edit Book"></li>
